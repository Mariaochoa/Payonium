...
import { idlFactory } from './payonium_backend.did.js';
export { idlFactory } from './payonium_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PAYONIUM_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./payonium_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the payonium_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./payonium_backend.did.js")._SERVICE>}
 */
export const payonium_backend = createActor(canisterId);
