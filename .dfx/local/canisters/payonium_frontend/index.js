...
import { idlFactory } from './payonium_frontend.did.js';
export { idlFactory } from './payonium_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PAYONIUM_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./payonium_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the payonium_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./payonium_frontend.did.js")._SERVICE>}
 */
export const payonium_frontend = createActor(canisterId);
